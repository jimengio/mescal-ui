    ...
    <div className={styleContainer}>
      ...
      <div>
        ...
        <InputRadio
          ...
          value={radio1}
          options={[
            { label: "demo01", value: "demo01" },
            { label: "demo02", value: "demo02" },
          ]}
        ...
        <InputRadio
          ...
          value={radio2}
          options={[
            { label: "demo03", value: "demo03" },
            { label: "demo04", value: "demo04" },
          ]}
        ...
        <InputRadio
          ...
          value={radio3}
          options={[
            { label: "demo05", value: "demo05", disabled: true },
            { label: "demo06", value: "demo06" },
            { label: "demo07", value: "demo07" },
          ]}
        ...
        <InputRadio
          ...
          value={radio4}
          options={[
            { label: "demo08", value: "demo08" },
            { label: "demo09", value: "demo09" },
          ]}
        ...
        <InputRadio
          ...
          value={radio6}
          options={[
            { label: "demo10", value: "demo10" },
            { label: "demo11", value: "demo11" },
          ]}
        ...
        <InputRadio
          ...
          value={radio7}
          options={[
            { label: "demo12", value: "demo12" },
            { label: "demo13", value: "demo13" },
          ]}
        ...
        <InputRadio
          ...
          value={radio9}
          options={[
            { label: "合格", value: "ok", activeColor: "#49BC19" },
            { label: "不合格", value: "ng", activeColor: "#f2536e" },
          ]}
